...
def ffhq128_autoenc_joint():
    ...
    conf.total_samples = 101_000_000
    conf.latent_loss_type = LossType.l1
    conf.latent_beta_scheduler = 'const0.008' # const0.008'
    conf.beta_scheduler = 'const0.008'
    conf.name = 'ffhq128_autoenc_joint_debug'
    conf.train_mode = TrainMode.joint
    conf.ldm_weight=1.0
    return conf
...
def horse128_autoenc_joint():
    ...
    conf.latent_loss_type = LossType.l1
    conf.beta_scheduler = 'const0.008'
    conf.name = 'horse128_autoenc_joint'
    conf.train_mode = TrainMode.joint
    conf.ldm_weight=1.0
    return conf
...
def bedroom128_autoenc_joint():
    ...
    conf.latent_beta_scheduler = 'const0.008' # const0.008'
    conf.beta_scheduler = 'const0.008'
    conf.name = 'bedroom128_autoenc_joint'
    conf.train_mode = TrainMode.joint
    conf.ldm_weight=1.0
    return conf
...
def celeba64d2c_autoenc_joint():
    ...
    conf.latent_beta_scheduler = 'const0.008'
    conf.latent_loss_type = LossType.l1
    conf.name = 'celeba64d2c_autoenc_joint'
    conf.train_mode = TrainMode.joint
    return conf

def celeba128_autoenc_joint_eval():
    conf = autoenc_base()
    conf.data_name = 'celebahq'
    conf.img_size = 128
    conf.net_ch = 128
    ...
    conf.latent_beta_scheduler = 'const0.008' # const0.008'
    conf.beta_scheduler = 'const0.008'
    conf.name = 'celeba128_autoenc_joint_eval'
