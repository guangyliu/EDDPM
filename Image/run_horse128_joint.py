...
if __name__ == '__main__':
    ...
    conf.batch_size = 25 # 100
    conf.ldm_weight = 1.6  # w,   2-w
    conf.T_eval = 100
    conf.latent_T_eval = 100
    conf.name = 'horse_4gpu_b100_l0_lc_w1.6_scale_ft_teval100' #'v6_b100_l0_lc_w1_scale_scldm' #4gpu_noscale_noln_d3_w'+str(conf.ldm_weight)+'_b200_ll_l2l2_detach1_ft'  # ckpt name
    conf.lr = 4e-6
